...
// Col 0: item_code | Col 1: location | Col 2: lot_number (new) | Col 3: carton_number
const PREVIEW_COL_INDICES = [0, 1, 2, 3];
const PREVIEW_COL_LABELS = ['Item Code', 'Location', 'New Lot Number', 'Carton Number'];
...
const handleDownloadTemplate = async () => {
    ...
    worksheet.columns = [
        ...
        { header: 'lot_number', key: 'lot_number', width: 20 },
        { header: 'carton_number', key: 'carton_number', width: 25 },
    ];
    ...
    worksheet.addRow({ item_code: 'SKU00123', location: 'A-01-01', lot_number: 'YN2603093', carton_number: '7A-23D2604260001' });
    worksheet.addRow({ item_code: 'SKU00456', location: 'A-01-02', lot_number: 'YN2603091', carton_number: 'YX1032604160001' });
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div className="text-sm text-blue-800 flex-1">
                                        ...
                                        <ul className="list-disc list-inside space-y-1 text-xs">
                                            <li>Kolom A: <strong>Item Code</strong>, Kolom B: <strong>Location</strong>, Kolom C: <strong>Lot Number (baru)</strong>, Kolom D: <strong>Carton Number</strong></li>
                                            <li>Row 1 dianggap header dan akan dilewati</li>
                                            <li><strong>Carton Number wajib diisi</strong> — dipakai sebagai kunci pencocokan bersama Item Code + Location, karena satu lokasi bisa berisi lebih dari satu carton dengan lot berbeda</li>
                                            <li>Baris inventory dengan Carton Number kosong di sistem tidak akan ter-update (tidak cocok dengan kriteria pencocokan)</li>
                                            <li>Baris dengan qty available = 0 akan gagal validasi</li>
                                            <li>Pasangan yang tidak ditemukan akan gagal dan tidak ada yang di-update (all-or-nothing per file)</li>
                                                    ...
                                                    {row.map((cell, ci) => (
                                                        <td
                                                            ...
                                                            className={`px-3 py-2 text-sm text-gray-900 whitespace-nowrap max-w-xs truncate
                                                                ...
                                                                ${ci === 2 ? 'font-mono text-emerald-700 font-medium' : ''}
                                                                ${ci === 3 ? 'font-mono text-slate-600' : ''}
                                                            `}
                                                        >
