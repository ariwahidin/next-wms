...
export default function SupplierExcelUpload() {
    ...
    const handleDownloadTemplate = () => {
        ...
        worksheet.addRow([
            ...
            "Indonesia",
            "+62 21 8889876",
            "info@primasejahtera.co.id",
            "OWN001",
        ]);
        worksheet.addRow([
            "SUPP003",
            "UD. Cahaya Mandiri",
            "Jl. Soekarno Hatta 123",
            "Bandung",
            "Indonesia",
            "+62 22 7654321",
            "contact@cahayamandiri.com",
            "OWN002",
        ]);

        // Set column widths
        worksheet.columns = [
            { width: 16 }, // SUPPLIER_CODE
            { width: 25 }, // SUPPLIER_NAME
            { width: 25 }, // ADDRESS
            { width: 15 }, // CITY
            { width: 15 }, // COUNTRY
            { width: 18 }, // PHONE
        ...
        workbook.xlsx.writeBuffer().then((buffer) => {
            ...
            a.href = url;
            a.download = "supplier_upload_template.xlsx";
            a.click();
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await api.post("/suppliers/upload-excel", formData, {
    ...
    return (
        <Layout title="Master Supplier" subTitle="Import from Excel">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="border-b border-gray-200 px-6 py-4">
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                            Upload an Excel file to create multiple suppliers at once
                        </p>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            ...
                            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                                <li>Download the template and fill in your supplier data</li>
                                <li>
                                    <strong>SUPPLIER_CODE and OWNER_CODE</strong> will be converted to UPPERCASE automatically
                                </li>
                                <li>
                                    <strong>SUPPLIER_CODE, SUPPLIER_NAME, and OWNER_CODE</strong> are required fields
                                </li>
                                <li>
                                    <strong>OWNER_CODE must exist</strong> in the Owners master data
                                </li>
                                <li>
                                    Suppliers with existing supplier codes will be skipped (not updated)
                                </li>
                                <li>Email format will be validated if provided</li>
                                <li>Other fields (address, phone, city, country) are optional</li>
                            </ul>
                        </div>
                                ...
                                {result.skipped_items.length > 0 && (
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                        <h4 className="text-sm font-medium text-yellow-800 mb-2">
                                            ⚠️ Skipped Suppliers (Already Exist)
                                        </h4>
