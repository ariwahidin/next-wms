...
export default function CustomerExcelUpload() {
    ...
    const handleDownloadTemplate = () => {
        ...
        // Set column widths
        worksheet.columns = [
            { width: 16 }, // CUSTOMER_CODE
            { width: 25 }, // CUSTOMER_NAME
            { width: 25 }, // ADDRESS_1
            { width: 20 }, // ADDRESS_2
            { width: 15 }, // CITY
            { width: 18 }, // AREA
    ...
    return (
        <Layout title="Customers" subTitle="Import from Excel">
                    ...
                    <div className="p-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            ...
                            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                                <li>Download the template and fill in your customer data</li>
                                <li>
                                    <strong>CUSTOMER_CODE</strong> will be converted to UPPERCASE automatically
                                </li>
                                <li>
                                    <strong>CUSTOMER_CODE and CUSTOMER_NAME</strong> are required fields
                                </li>
                                <li>
                                    Customers with existing customer codes will be skipped (not updated)
                                </li>
                                <li>Email format will be validated if provided</li>
                                <li>Other fields (address, phone, etc.) are optional</li>
                            </ul>
                        </div>
                                ...
                                {result.skipped_items.length > 0 && (
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                        <h4 className="text-sm font-medium text-yellow-800 mb-2">
                                            ⚠️ Skipped Customers (Already Exist)
                                        </h4>
