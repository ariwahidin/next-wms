...
export default function DownloadActivityReport() {
  ...
  const handleDownload = () => {
    ...
    const url = `/api/download-cyclecount-outbound?startDate=${startDate}&endDate=${endDate}`
  ...
  return (
    <Layout title="Report" titleLink="/wms/report/cyclecount-outbound" subTitle="Cycle Count Outbound">
      <div className="p-6 space-y-6">
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-medium mb-2">Select Date Range</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Choose a date range for the report.. Maximum range is 3 months.
            </p>
