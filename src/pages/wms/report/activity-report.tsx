...
export default function DownloadActivityReport() {
  ...
  const handleDownload = () => {
    ...
    const url = `/api/download-activity-report?startDate=${startDate}&endDate=${endDate}`
  ...
  return (
    <Layout title="Report" titleLink="/wms/report/activity-report" subTitle="Activity Report">
      <div className="p-6 space-y-6">
        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-medium mb-2">Select Date Range</h3>
            <p className="text-sm text-muted-foreground mb-4">
              Choose a date range for the activity report. Maximum range is 3 months.
            </p>
