...
export default function UomConversionExcelUpload() {
    ...
    const handleDownloadTemplate = () => {
        const workbook = new XLSX.Workbook();
        const worksheet = workbook.addWorksheet("UOM Conversions");
        ...
        workbook.xlsx.writeBuffer().then((buffer) => {
            ...
            a.href = url;
            a.download = "uom_conversion_upload_template.xlsx";
            a.click();
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const response = await api.post("/uoms/conversion/upload-excel", formData, {
    ...
    return (
        ...
        <Layout title="Settings" subTitle="UoM Conversion - Import Excel">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div className="border-b border-gray-200 px-6 py-4">
                        <h2 className="text-xl font-semibold text-gray-900">
                            Upload UOM Conversions from Excel
                        </h2>
                        <p className="text-sm text-gray-500 mt-1">
                            Upload an Excel file to create multiple UOM conversions at once
                        </p>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            ...
                            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                                <li>Download the template and fill in your UOM conversion data</li>
                                ...
                                <li>
                                    <strong>FROM_UOM and TO_UOM must exist</strong> in the UOM master
                                </li>
                                <li>
                                    Duplicate conversions (same ITEM_CODE, EAN, FROM_UOM, TO_UOM)
                                    will be skipped
                                </li>
                                <li>CONVERSION_RATE must be greater than 0</li>
                                <li>
                                    IS_BASE accepts: YES/NO, TRUE/FALSE, 1/0 (case insensitive)
                                </li>
                            </ul>
                        </div>
